...
class Mahasiswa extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array(); // Add this line
		$this->load->view("layout/header", $data); // Pass the $data array to the header view
	...
	public function edit($id)
	{
		...
		$this->form_validation->set_rules('nama_prodi', 'Prodi', 'required', [
			'required' => 'Prodi Mahasiswa Wajib di isi'
		]);
		$this->form_validation->set_rules('alamat', 'Alamat', 'required', [
			'required' => 'Alamat Mahasiswa Wajib di isi'
