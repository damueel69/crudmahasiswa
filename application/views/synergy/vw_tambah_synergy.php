<div class="container">
    <h2 class="mt-5 text-center">Tambah Synergy</h2>
    <form method="post" action="<?= site_url('Synergy/synergy_tambah') ?>" class="col-6 mx-auto">
        <div class="mb-3">
            <label for="nama_synergy" class="form-label">Nama Synergy</label>
            <input type="text" class="form-control" id="nama_synergy" name="nama_synergy" required>
        ...
        <div class="mb-3 text-center">
            <button type="submit" class="btn btn-primary">Tambah Synergy</button>
